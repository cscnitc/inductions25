...
def gen_shared_secret(Q: tuple, n: int):
    # Bhuvan's Public key, my secret int
...
``` output.txt
Point(x=215367289074344640988744078387395856873, y=30104558730262216114960374112145701599)
{'iv': '1cc39d6fff645e0b167425f48a567dc7', 'encrypted_flag': 'cd62be808bb5b0c873bcdaf291bdaf283eee04eb5e47505405572b9a21152510'}
```
